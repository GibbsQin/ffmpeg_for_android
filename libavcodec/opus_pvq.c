                                                     ...
                                                     int fill, int quant)
{
    ...
    if (!stereo && level == 0) {
        ...
        if (lowband &&
            (recombine || ((N_B & 1) == 0 && tf_change < 0) || bo > 1)) {
            for (i = 0; i < N; i++)
